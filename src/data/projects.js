...
export const projects = [
  ...
  },
  {
    ...
    strategy: [
      ...
      "UMF KOREA 2024: 즉시 당첨 결과를 확인할 수 있는 룰렛형 항공권 이벤트를 진행하여 참여도를 높이고, '항공권 즉시 증정'이라는 요소를 활용해 자체 바이럴 확산 유도",
      '넥슨 블루 아카이브 3주년: 게임 팬덤 몰입형 페스티벌을 고려하여, 게임 IP(게임 내 배경 도시, 캐릭터 명)를 활용한 이벤트 요소 구성',
      '협력사·유관부서·현장 인력 조율 및 현장 이슈 대응',
    ],
    impact: [
      'UMF KOREA 2024 에어로케이 이벤트 참여자 5,000명 이상 달성',
      '블루 아카이브 3주년 에어로케이 이벤트 참여자 2,000명 이상 달성',
  ...
  },
  {
    ...
    strategy: [
      '취항지 분위기를 시각적 요소에 사운드 요소를 더해 콘텐츠로 기획',
      '콘텐츠 방향 설정 및 세부 촬영 내용, 유관부서 협의 및 조율',
    ],
    impact: [
      '콘텐츠 영상 조회수 40,000회 이상 달성',
      '음악 콘텐츠로 신규 취항지 스토리 전달',
    ],
  },
  {
    id: 'rescue_dog',
    category: 'brand',
    client: '에어로케이항공',
    title: '유기견 입양 활성화 캠페인, 181번째 가족을 찾습니다',
    period: '2023.12',
    contribution: 80,
  ...
  },
  {
    ...
    problem: [
      '반려동물 동반 탑승 수요 증가에 따라 펫 동반 탑승 서비스 전반의 브랜드 경험 개선 필요',
