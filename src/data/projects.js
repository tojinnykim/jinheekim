...
export const projects = [
  ...
  },
  {
    ...
    problem: [
      ...
      '자체 상품 라인으로 수익성·차별성 강화 필요',
    ],
    strategy: [
      '백화점 입점·팝업 운영과 매장 가이드 정비로 브랜드 경험 표준화',
      '자체 브랜드 라인 Natural Gourmet 제품 개발·SKU 확장, 패키지 디자인 디렉팅',
      'POP·디스플레이·운영 가이드 정비로 매장 브랜드 경험 표준화',
      'Valentino, BMW Korea, 프리메라, 캐리어 등 프리미엄 브랜드 협업 실행, 펫 클래스·라이브커머스·콘텐츠 협업 운영',
    ],
    impact: [
  ...
  },
  {
    ...
    impact: [
      '전환 목표 190% 초과 달성',
      '지역 타깃 디지털 캠페인과 OOH를 연계해 전환 295건, CPA 86% 절감 (81,710원 → 25,762원)',
      '대학내일 협업 콘텐츠 조회수 132,264회 달성',
    ],
  },
  {
    id: 'panasonic',
    category: 'growth',
    client: '파나소닉 코리아',
    title: '디지털 캠페인, 2018평창동계올림픽 골든패키지',
  ...
  },
  {
    ...
    impact: [
      '트래블 매거진 사이트 트래픽(세션, 유입 유저 수, 페이지뷰 수) 2배 이상 증가',
  ...
  },
  {
    ...
    strategy: [
      '주요 글로벌 유튜버(Dude Perfect, Mystery Guitar Man, Wong Fu Productions) 섭외·계약·커뮤니케이션 지원',
